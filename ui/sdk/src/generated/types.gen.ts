 ...
 */
export type AppendSessionConversationRequest_unstable = {
    sessionId: string;
    role?: AppendMessageRole;
    text: string;
};

export type AppendMessageRole = 'user' | 'assistant';

export type AppendSessionConversationResponse_unstable = {
    messageId: string;
};
